...
### Singolo video
```bash
python scripts/run_pose_estimation.py --video data/input/videos/soggetto001/camminata.mp4
```

Il soggetto viene estratto automaticamente dal path. Output:
```
data/output/soggetto001/camminata.jsonl
data/output/soggetto001/camminata_overlay.mp4
```
...
--stride 2          # Elabora 1 frame ogni 2
