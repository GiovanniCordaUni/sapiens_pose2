...
Encapsulates YOLO model loading and person detection.
"""
...
class YoloPersonDetector:
    """
    YOLO-based person detector with tracking support.
    
    Wraps YOLO model for detecting persons and maintaining temporal
