...
Functions and classes for writing pose estimation results to JSONL format.
"""
...
def create_pose_record(
    ...
    Args:
        ...
        keypoints: List of [x, y, score] for each keypoint
        keypoint_indices: Indices of keypoints in model output
        num_keypoints_total: Total keypoints in model
