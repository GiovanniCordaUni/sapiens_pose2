...
Functions for drawing skeletons and keypoints on images.
"""
...
def draw_coco17(
    ...
    """
    Draw COCO 17-keypoint skeleton on an image.
    ...
    Args:
        ...
        edges: Custom skeleton edges (default: COCO17_EDGES)
        
    Returns:
        Image with drawn skeleton (copy of input)
    """
    out = frame_bgr.copy()
