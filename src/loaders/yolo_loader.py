...
class YoloPersonDetector:
    ...
    Args:
        ...
        confidence: Confidenza minima per il rilevamento
        imgsz: Dimensione immagine di input per YOLO
        person_class_id: ID della classe per la persona nel modello (default: 0)
        iou_bias: Peso per IoU vs confidenza nel tracciamento (0-1)
    ...
    def predict(
        ...
        """
        Esegue la predizione YOLO su un frame.
        
        Args:
            frame: Immagine BGR come array numpy
            confidence: Sovrascrive la soglia di confidenza predefinita
            imgsz: Sovrascrive la dimensione immagine predefinita
    ...
    def detect(
        ...
        """
        Rileva la person migliore in un frame.
        
        Args:
            frame: Immagine BGR come array numpy
            prev_box: Box del frame precedente per il tracciamento (opzionale)
            confidence: Sovrascrive la soglia di confidenza predefinita
            
        Returns:
            Tuple di (box_xyxy, confidence) o (None, None) se nessuna persona trovata
        """
    ...
    def detect_with_padding(
        ...
        """
        rileva la persona e restituisce il bounding box con padding e clamp.
        
        Args:
            frame: Immagine BGR come array numpy
            prev_box: Box del frame precedente per il tracciamento (opzionale)
            padding_ratio: Padding come frazione delle dimensioni del box
            confidence: Sovrascrive la soglia di confidenza predefinita
            
        Returns:
            Tuple di (padded_box_xyxy, confidence) o (None, None)
        """
        H, W = frame.shape[:2]
